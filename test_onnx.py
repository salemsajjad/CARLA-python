...
def infer_yolop(weight="yolop-640-640.onnx",
    ...
    save_det_path = "./pictures/detect_onnx_iran.jpg"
    save_da_path = "./pictures/da_onnx_iran.jpg"
    save_ll_path = "./pictures/ll_onnx_iran.jpg"
    save_merge_path = "./pictures/output_onnx_iran.jpg"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img', type=str, default="./pictures/1.bmp")
