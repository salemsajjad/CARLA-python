...
def run_simulation(args, client):
    ...
    try:
        ...
        display_manager = DisplayManager(grid_size=[1,0], window_size=[args.width, args.height])
        ...
        SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=1, z=1.35), carla.Rotation(yaw=+00)), 
                      vehicle, {}, display_pos=[0, 0])
        # SensorManager(world, display_manager, 'RGBCamera', carla.Transform(carla.Location(x=0, z=2.4), carla.Rotation(yaw=+90)), 
